 ...
 *  instances of a BetterBasket as they are progressed through the system.
 * These stages are:
...
public class Order implements OrderProcessing
{
   ...
   * @param  basket an instance of a better basket
   * @return Description of contents
   */
  public String asString( BetterBasket basket )
  {
   ...
   */
  public synchronized BetterBasket getOrderToPick()
         throws OrderException
  {
